const techIcons = {
    ...
    Scala: '<svg class="tech-icon" viewBox="0 0 24 24"><path fill="currentColor" d="M4.589 24c4.537 0 13.81-1.516 14.821-3v-2.957c-1.012 1.388-10.284 2.442-14.821 2.442v3.515z"/></svg>',
...
const projects = [
    ...
    },
    {
        ...
        technologies: [
            "Java", "Scala", "C#", "MySQL", "Unity", "Firebase",
